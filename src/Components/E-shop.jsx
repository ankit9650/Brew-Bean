          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center mt-8 space-x-4 p-4">
              <ECard
                ...
                description="Arabica beans are larger, sweeter, and more expensive than their prime competition, the Robusta."
                price="1090"
                addToCart={addToCart}
              />
              <ECard
                ...
                description="Robusta beans have almost double the caffeine content of Arabica beans and are known for a stronger and more bitter taste and smell."
                price="900"
                addToCart={addToCart}
              />
              <ECard
                ...
                description="Catimor beans are a hybrid between Caturra & Timor beans which is where their unique name comes from"
                price="890"
                addToCart={addToCart}
              />
            </div>
            <div className="flex justify-center mt-0 space-x-4 p-4">
              <ECard
                ...
                description="Our Organic/Biodynamic Darjeeling 1st flush is harvested in mid-March following the spring rains and produces a sharp, clear, taste. Slightly astringent, makes a light golden cup."
                price="650"
                addToCart={addToCart}
              />
              <ECard
                image="https://tasteofchai.in/cdn/shop/files/JasmineTea.jpg?v=1693488614"
                title="Jasmine Petals Tea"
                description="A smooth, delicate liquor is produced from organic green tea infused with the fragrance of jasmine petals"
                price="760"
                addToCart={addToCart}
              />
              <ECard
                image="https://uk.ahmadtea.com/cdn/shop/products/20FApricotface1_600x600_crop_center.jpg?v=1634899183"
                title="Apricot Black Tea"
                description="A blend of Nepali black tea, fruity and floral notes"
                price="850"
                addToCart={addToCart}
              />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center mt-8 space-x-4 p-4">
              <ECard
                ...
                title="Coca Cola"
                description="Coca-Cola is a sweetened, carbonated beverage that is manufactured by the Coca-Cola Company. "
                price="150"
                addToCart={addToCart}
              />
              <ECard
              ...
              <ECard
                ...
                title="Prime Drink"
                description="Prime is a range of sports drinks, drink mixes, and energy drinks created and marketed by Prime Hydration, LLC."
                price="650"
                addToCart={addToCart}
              />
            </div>
            <div className="flex justify-center mt-0 space-x-4 p-4">
              <ECard
                ...
                title="Sandwiches"
                description="A classic sandwich made with cheese melted between two slices of bread."
                price="150"
                addToCart={addToCart}
              />
              <ECard
                ...
                title="Veg Patty"
                description="These ingredients are often combined with breadcrumbs, eggs (or a vegan egg substitute), and spices to create a patty-shaped patty."
                price="50"
                addToCart={addToCart}
              />
              <ECard
                ...
                title="Burgers"
                description=" A burger with a slice of cheese melted on top.The patty can be made from various types of meat, such as beef, pork, chicken, lamb, or even fish."
                price="250"
                addToCart={addToCart}
              />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center mt-8 space-x-4 p-4">
              <ECard
                ...
                description="A stainless steel black mug is a durable and stylish drinking vessel that offers both functionality and aesthetic appeal. "
                price="499"
                addToCart={addToCart}
              />
              <ECard
                ...
                description="An electric frother is a small, handheld device used to create a frothy texture in liquids. "
                price="450"
                addToCart={addToCart}
              />
              <ECard
                ...
                title="Coffee Sipper"
                description="Coffee sippers appreciate the ritual of drinking coffee and enjoy the experience as much as the taste."
                price="650"
                addToCart={addToCart}
              />
            </div>
            <div className="flex justify-center mt-0 space-x-4 p-4">
              <ECard
                ...
                title="Coffee Sachets"
                description="50 Sachets of Nescafe coffee with different flavours and Brews"
                price="250"
                addToCart={addToCart}
              />
              <ECard
                image="https://nutcaseshop.com/cdn/shop/products/NC-CUS-TUMCFF-WHITE-0016b.jpg?v=1675255052"
                title="Travel Coffee Mug"
                description="A convenient way to enjoy your favorite hot beverages while commuting, traveling, or simply enjoying the outdoors."
                price="780"
                addToCart={addToCart}
              />
              <ECard
                image="https://homafy.com/wp-content/uploads/2023/03/customized-mugs-for-girl-Copy.jpg"
                title="Customizable Mugs"
                description="Give a personalized mug to a friend, family member, or loved one.Look for a mug that is well-made and durable"
                price="799"
                addToCart={addToCart}
              />
            </div>
